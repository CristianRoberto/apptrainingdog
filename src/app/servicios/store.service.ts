...
export class StoreService {
  ...
  private datas=[
    ...
    {id:2,name:'Tienda Andrade ', distance:'20' ,img :"https://i0.wp.com/exitosanoticias.pe/v1/wp-content/uploads/2020/03/supermercados.png", score:"9.1", tipe:"Tienda", place:"Barrio 15 de abril",type:"tienda", description:"Carnes legumbres, aseo y más"},
